    ...
    <div className="container mx-auto p-4 font-sans">
      ...
      <div className="mb-4 flex flex-col sm:flex-row">
        <input
          ...
          className="border p-2 rounded-lg border-solid border-gray-300 shadow-xl w-full sm:w-[30rem] sm:ml-[12rem] mb-2 sm:mb-0"
        />

        <select
          value={month}
          onChange={handleMonthChange}
          className="border p-2 rounded-lg border-solid border-gray-300 shadow-xl w-full sm:w-auto mb-2 sm:mb-0 sm:ml-2"
        >
        ...
        <select
          ...
          className="border p-2 rounded-lg border-solid border-gray-300 shadow-xl w-full sm:w-auto sm:ml-2"
        >
      ...
      <div className="border-2 border-gray-300 rounded-lg shadow-lg overflow-hidden mx-auto w-full sm:w-3/4">
          ...
          <tbody>
            {transactions.map((transaction) => (
              <tr key={transaction.id} className="hover:bg-gray-100 transition duration-200">
                ...
                <td className="border-b border-r border-gray-300 px-4 py-3">{transaction.sold ? "Yes" : "No"}</td>
